...
export const signupService = async (name, email, mobileNumber, password) => {
    ...
    if (existingUser) {
        ...
        throw new DuplicateUserError(`A user with this ${duplicateField} already exists. Please use a different ${duplicateField} or try logging in.`, duplicateField === 'email address' ? 'email' : 'mobileNumber');
    }
    // Hash password
